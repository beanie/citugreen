...
//			def xml15 = new EnergyFileRef(urlPath:'http://20.20.3.28/xmlelectricity11.xml', category:'Electricity').save()
		...
		if(!User.count()) {
			...
			Premise philsFlat = new Premise(occupied:true, bathrooms:1, premiseType:'Flat', core:'None', bedrooms:1, flatNo:'308', addressLine1:'Sonic House', addressLine2:'CituGreen Est.', postCode:'SW5 3AP', user:phil).save()
			Premise bensFlat = new Premise(occupied:true, bathrooms:1, premiseType:'Flat', core:'None', bedrooms:1, flatNo:'309', addressLine1:'Beanie House', addressLine2:'CituGreen Est.', postCode:'SW15 5AS', user:ben).save()
			Premise bobsFlat = new Premise(occupied:true, bathrooms:1, premiseType:'Flat', core:'None', bedrooms:1, flatNo:'607', addressLine1:'Sonic House', addressLine2:'CituGreen Est.', postCode:'SW5 3AP', user:phil).save()
			Premise keithsFlat = new Premise(occupied:true, bathrooms:1, premiseType:'Flat', core:'None', bedrooms:1, flatNo:'215',addressLine1:'Beanie House', addressLine2:'CituGreen Est.', postCode:'SW15 5AS', user:ben).save()
			Premise johnsFlat = new Premise(occupied:true, bathrooms:1, premiseType:'Flat', core:'None', bedrooms:2, flatNo:'606', addressLine1:'Sonic House', addressLine2:'CituGreen Est.', postCode:'SW5 3AP', user:john).save()
			Premise helenFlat = new Premise(occupied:true, bathrooms:1, premiseType:'Flat', core:'None', bedrooms:2, flatNo:'608', addressLine1:'Beanie House', addressLine2:'CituGreen Est.', postCode:'SW5 3AP', user:helen).save()
			Premise jacksFlat = new Premise(occupied:true, bathrooms:1, premiseType:'Flat', core:'None', bedrooms:2, flatNo:'106', addressLine1:'Sonic House', addressLine2:'CituGreen Est.', postCode:'SW5 3AP', user:phil).save()
			Premise neilsFlat = new Premise(occupied:true, bathrooms:1, premiseType:'Flat', core:'None', bedrooms:2, flatNo:'610', addressLine1:'Beanie House', addressLine2:'CituGreen Est.', postCode:'SW5 3AP', user:neil).save()
