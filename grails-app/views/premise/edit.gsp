    ...
    <body>
        ...
        <div class="body">
            ...
            <g:form method="post" >
                ...
                <g:hiddenField name="version" value="${premiseInstance?.version}" />
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="setTobBoxes"><g:message code="premise.setTobBoxes.label" default="Set Tob Boxes" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: premiseInstance, field: 'setTobBoxes', 'errors')}">
...
<g:link controller="setTopBox" action="create" params="['premise.id': premiseInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'setTopBox.label', default: 'SetTopBox')])}</g:link>
